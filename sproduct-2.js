...
function ready() {
  ...
  detailsSection.getElementsByTagName("h5")[0].innerHTML =
    localStorage.getItem("p_brand");
  detailsSection.getElementsByTagName("h4")[0].innerHTML =
    localStorage.getItem("p_title");
  detailsSection.getElementsByTagName("h2")[0].innerHTML =
    localStorage.getItem("p_price");

  detailsSection.getElementsByTagName("h6")[0].innerHTML =
    localStorage.getItem("p_path");

  detailsSection.getElementsByTagName("span")[0].innerHTML =
    localStorage.getItem("p_description");

  document.getElementsByClassName("small-img")[0].src =
    localStorage.getItem("p_srcSmallImg0");
  document.getElementsByClassName("small-img")[1].src =
    localStorage.getItem("p_srcSmallImg1");
  document.getElementsByClassName("small-img")[2].src =
    localStorage.getItem("p_srcSmallImg2");
  document.getElementsByClassName("small-img")[3].src =
    localStorage.getItem("p_srcSmallImg3");
